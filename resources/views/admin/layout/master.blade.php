...
<body>
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <form action="{{ url('admin/logout') }}" method="post" class="a dropdown-item d-flex">
                  @csrf
                    <i class="ni ni-user-run"></i>
                    <input type="submit" value="logout" class="dropdown-item p-0">
                </form>
              </div>
            </li>
          </ul>
  ...
  <script>
    $(document).ready(function(){
      $('.dele-confirm').click(function(event){
