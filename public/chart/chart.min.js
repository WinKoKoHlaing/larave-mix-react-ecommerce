...
!(function (t, e) {
    ...
    class Cs {
        ...
        applyStack(t, e, i) {
            const s = this.chart,
                ...
                o = e[t.axis];
            return _s(
                { keys: xs(s, !0), values: e._stacks[t.axis] },
                o,
                n.index,
                { mode: i }
            );
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta,
                ...
                r = ((t, e, i) =>
                    t &&
                    !e.hidden &&
                    e._stacked && { keys: xs(i, !0), values: null })(
                    e,
                    i,
                    this.chart
                ),
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                f.$shared &&
                    ((f.$shared = r), (n[o] = Object.freeze(Ds(f, r)))),
                f
            );
        }
                ...
                c + 6 > o &&
                    ...
                    (l = Ut(
                        Math.min(
                            ...
                            Math.asin(Qt(a / r, -1, 1)) -
                                Math.asin(Qt(d / r, -1, 1))
                        )
                    )),
    ...
    class Ws {
        ...
        unregister(t) {
            ...
            i in e && delete e[i],
                s &&
                    i in yt[s] &&
                    (delete yt[s][i], this.override && delete mt[i]);
        }
    }
    var Hs = new (class {
        constructor() {
    ...
    const sn = (t) =>
        q(t) &&
        Object.getOwnPropertyNames(t).reduce((e, i) => e || ft(t[i]), !1);
    const nn = ["top", "bottom", "left", "right", "chartArea"];
    function on(t, e) {
        return (
            "top" === t || "bottom" === t || (-1 === nn.indexOf(t) && "x" === e)
        );
    }
    function an(t, e) {
        return function (i, s) {
                        ...
                        (o = u
                            ? Qt(
                                  Math.max(
                                      ...
                                      i
                                          ? 0
                                          : wt(e, l, a.getPixelForValue(c)).hi +
                                                1
                                  ),
                                  n,
                                  s
            ...
            e.fullCircles &&
                (function (t, e, i) {
                    ...
                    for (
                        ...
                        t.stroke();
                    for (
                        t.beginPath(), t.arc(s, n, l, o, o + At), c = 0;
                        c < r;
                        ++c
                    )
                        t.stroke();
    ...
    class Gn extends Os {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Mi(this, this.options.segment))
            );
        }
        first() {
    ...
    function io(t, e, i, s) {
        const n = null === e,
            ...
            a = t && !(n && o) && Qn(t, s);
        return (
            a && (n || ee(e, a.left, a.right)) && (o || ee(i, a.top, a.bottom))
        );
    }
    function so(t, e) {
        ...
        _getLegendItemAt(t, e) {
            ...
            if (ee(t, this.left, this.right) && ee(e, this.top, this.bottom))
                for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                    if (
                        ((s = n[i]),
                        ee(t, s.left, s.left + s.width) &&
                            ee(e, s.top, s.top + s.height))
                    )
    ...
    class Yo extends Os {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = Io(a, zo(s))), (a = Io(a, zo(n))), (a = Io(a, zo(o))), a
            );
        }
        getBeforeBody(t, e) {
            ...
            const s = (function (t, e) {
                ...
                for (
                    ...
                    (d && v !== o
                        ? (i.push({ value: o }),
                          v < o && P++,
                          Ht(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) &&
                              P++)
                        : v < o && P++);
                    P < M;
                    ++P
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = da.indexOf(t) + 1, i = da.length;
                                  e < i;
                                  ++e
                              )
